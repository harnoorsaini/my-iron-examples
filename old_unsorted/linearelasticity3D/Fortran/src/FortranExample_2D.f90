...
#include "mpif.h"
  ...
  IF(EXPORT_FIELD) THEN
    ...
    CALL cmfe_Fields_NodesExport(Fields,"LinearElasticity2DExtensionPlaneStressLagrangeBasisExample","FORTRAN",Err)
    CALL cmfe_Fields_ElementsExport(Fields,"LinearElasticity2DExtensionPlaneStressLagrangeBasisExample","FORTRAN",Err)
