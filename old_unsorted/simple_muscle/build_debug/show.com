...
#gfx read node MainTime_1_5.part0.exnode 
#gfx read node MainTime_M_2_5.part0.exnode node_offset 10000

#gfx read node TESTExample_FE.part0.exnode
#gfx read node TESTExample_M.part0.exnode node_offset 10000

gfx read elem titinExample_FE.part0.exelem generate
gfx read elem titinExample_M.part0.exelem generate element_offset 10000 node_offset 10000 line_offset 10000 face_offset 10000
...
gfx modify g_element Region3D lines select_on material default selected_material default_selected;
...
#gfx modify g_element "Region3D" general clear circle_discretization 6 default_coordinate Geometry element_discretization "20*20*20" native_discretization none;
#gfx modify g_element "Region3D" lines select_on material white selected_material default_selected;
#gfx modify g_element "Region3D" lines coordinate deformed_coordinates select_on material green selected_material default_selected;
#gfx modify g_element "Region3D" node_points glyph point general size "1*1*1" centre 0,0,0 font default label cmiss_number select_on material gold selected_material default_selected;
#gfx modify g_element "Region3D" surfaces coordinate deformed_coordinates select_on invisible material default data pressure spectrum default selected_material default_selected render_shaded;
...
##
#gfx define field F gradient coordinate Geometry field deformed_coordinates
...
##
#gfx modify g_element "Region3D" general clear circle_discretization 6 default_coordinate deformed_coordinates element_discretization "4*4*4" native_discretization none
#gfx modify g_element "Region3D" lines select_on material default selected_material default_selected
#gfx modify g_element "Region3D" node_points glyph sphere general size "0.05*0.05*0.05" centre 0,0,0 select_on material default selected_material default_selected
##
## Also show undeformed lines to see what you are deforming from.
##
#gfx modify g_element "Region3D" lines coordinate Geometry select_on material jade selected_material default_selected
##
...
##
#gfx modify g_element "Region3D" element_points coordinate Geometry glyph point general size "0*0.02*0.02" centre 0,0,0 label principal_strains use_elements cell_centres discretization "1*1*1" native_discretization NONE select_on material default selected_material default_selected
