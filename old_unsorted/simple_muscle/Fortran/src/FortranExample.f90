...
!    & CMFE_EQUATIONS_SET_FINITE_ELASTICITY_TYPE,CMFE_EQUATIONS_SET_ACTIVE_STRAIN_SUBTYPE], &
    & CMFE_EQUATIONS_SET_FINITE_ELASTICITY_TYPE,CMFE_EQUATIONS_SET_SIMPLE_MUSCLE_SUBTYPE], &
!    & CMFE_EQUATIONS_SET_FINITE_ELASTICITY_TYPE,CMFE_EQUATIONS_SET_MOONEY_RIVLIN_SUBTYPE, &
  ...
  ! The Material Parameters are Set/initialised here
...
!        & CMFE_BOUNDARY_CONDITION_FIXED,1.2_CMISSRP*WIDTH,Err)
  ...
  ! Read in activation for all timesteps
...
!    ENDDO
    ...
    !update Activation
    CALL cmfe_Field_ParameterSetUpdateConstant(MaterialField,CMFE_FIELD_U_VARIABLE_TYPE,CMFE_FIELD_VALUES_SET_TYPE,8, &
      & 0.0_CMISSRP,Err)
