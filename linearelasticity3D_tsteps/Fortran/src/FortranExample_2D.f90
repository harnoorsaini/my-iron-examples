...
#include "mpif.h"
  ...
  REAL(CMISSRP) :: BCLOAD = -16.0_CMISSRP
  ...
  !Apply disp at nodes 2,4 at x=l
  ...
  DO node_idx=1,TotalNumberOfNodes
    DO component_idx=1,FieldGeometryNumberOfComponents
      CALL cmfe_Field_ParameterSetGetNode(GeometricField,CMFE_FIELD_U_VARIABLE_TYPE,CMFE_FIELD_VALUES_SET_TYPE,1,1,node_idx, &
        & component_idx,Value1,Err)
      CALL cmfe_Field_ParameterSetGetNode(DependentField,CMFE_FIELD_U_VARIABLE_TYPE,CMFE_FIELD_VALUES_SET_TYPE,1,1,node_idx, &
        & component_idx,Value2,Err)
      CALL cmfe_Field_ParameterSetAddNode(DependentField,CMFE_FIELD_U_VARIABLE_TYPE,CMFE_FIELD_VALUES_SET_TYPE,1,1,node_idx, &
